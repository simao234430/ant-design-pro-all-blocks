export default {
  ...
  'menu.system.config': '参数管理',
  'menu.system.notice': '通知公告',
  'menu.monitor': '监控',
  'menu.monitor.operlog': '操作日志',
  'menu.monitor.loginInfo': '登录日志',
  'menu.monitor.onlineUser': '在线用户',
  'menu.monitor.job': '定时任务',
  'menu.monitor.joblog': '任务日志',
  'menu.monitor.druid': 'Druid',
  'menu.monitor.serverInfo': '服务监控',
  'menu.monitor.cacheInfo': '缓存监控',
